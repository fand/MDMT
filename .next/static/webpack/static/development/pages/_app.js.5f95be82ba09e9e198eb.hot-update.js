...
})(["position:relative;width:100%;height:56px;", " transition:0.5s;background:transparent;.mobile{display:none;}@media (max-width:", "px){&.visible{background:linear-gradient( to bottom,0% ", ",90% ", ",100% ", " );}.mobile{display:block;}.pc{display:none;}}"], ''
/* line-height: 56px; */
...
//# sourceMappingURL=_app.js.5f95be82ba09e9e198eb.hot-update.js.map