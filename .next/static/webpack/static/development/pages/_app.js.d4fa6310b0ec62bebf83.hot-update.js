...
})(["width:100%;height:100%;padding:10px 20px 100px;background:rgba(10,10,10,0.6);border-right:1px solid gray;overflow:auto;-webkit-overflow-scrolling:touch;*{color:", ";text-shadow:0 2px 5px black !important;}ul{padding-left:0;margin:0;}li{line-height:2.5em;&.active{position:relative;&:before{display:block;content:'';position:absolute;right:10px;width:0;height:0;border-style:solid;border-width:50px 0 50px 50px;border-color:transparent transparent transparent #007bff;}text-decoration:none;font-weight:bold;font-style:italic;color:white;}}li a{display:block;text-decoration:none;&:hover{color:", ";text-decoration:underline;}&:visited{color:", ";}}"], _constants__WEBPACK_IMPORTED_MODULE_6__["default"].fg, _constants__WEBPACK_IMPORTED_MODULE_6__["default"].link, _constants__WEBPACK_IMPORTED_MODULE_6__["default"].fg);
...
//# sourceMappingURL=_app.js.d4fa6310b0ec62bebf83.hot-update.js.map