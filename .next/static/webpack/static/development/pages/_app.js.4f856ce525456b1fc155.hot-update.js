...
})(["position:relative;width:100%;height:56px;transition:0.5s;background:transparent;.mobile{display:none;}@media (max-width:", "px){&.visible{background:linear-gradient( to bottom,rgba(0,0,30,1),rgba(0,0,30,0.5) );}.mobile{display:block;}.pc{display:none;}}"], _constants__WEBPACK_IMPORTED_MODULE_3__["default"].mobile);
...
//# sourceMappingURL=_app.js.4f856ce525456b1fc155.hot-update.js.map